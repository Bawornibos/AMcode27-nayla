...
global.ext = {
	...
	body: '꧁ঔৣ☬AMͥcͣoͫde27☬ঔৣ꧂',
	thum: 'https://telegra.ph/file/1c2668a1f2cf1dd1d44e3.jpg'
}
global.mods = ['6282138037447'] // Want some help?
global.prems = JSON.parse(fs.readFileSync('./src/premium.json')) // Premium user has unlimited limit
global.DeveloperMode = 'true' // true or false
global.linkGC = ['https://chat.whatsapp.com/HTjpcqpNeeiGJM8mdbvTos']
global.packname = '꧁ঔৣ☬AMͥcͣoͫde27☬ঔৣ꧂'
global.author = '🪀◥དAdheBaworཌ◤'
global.multiplier = 36 // The higher, The harder levelup
global.sessionName = 'nayla' // The Session name behind the .json example is nayla.json
global.mesreport = 50
global.botname = '꧁ঔৣ☬AMͥcͣoͫde27☬ঔৣ꧂'
